...
The download functions return a `JSON3.Object` containing a GeoJSON FeatureCollection:
...
for feature in data.features
    ...
    println("$(props.IncidentName): $(props.DailyAcres) acres")
end

# Access geometry
feature = data.features[1]
geom = feature.geometry
println("Type: $(geom.type)")
println("Coordinates: $(geom.coordinates)")
```
