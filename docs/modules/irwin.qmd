...
ax = Axis(fig[1, 1], title="IRWIN Fire Occurrence (first 200 records)",
    xlabel="Longitude", ylabel="Latitude")
if !isempty(lons)
    sc = scatter!(ax, lons, lats, color=log10.(acres), colormap=:inferno, markersize=6)
    Colorbar(fig[1, 2], sc, label="log₁₀(IncidentSize)")
end
fig
```
